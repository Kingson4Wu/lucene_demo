...
public class DirectoryTest {
    ...
    String filePath = projectPath + File.separator + "LuceneDemo\\luceneDatasource\\IndexWriter addDocument's javadoc.txt";
    String indexPath = projectPath + File.separator + "LuceneDemo\\luceneIndex";
