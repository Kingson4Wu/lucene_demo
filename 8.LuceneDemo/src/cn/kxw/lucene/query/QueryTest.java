...
import cn.kxw.lucene.IndexDao;
import cn.kxw.lucene.QueryResult;
...
public class QueryTest {
    ...
    public void testRangeQuery() {
        ...
        //Term upperTerm = new Term("size", "500");//其实是按照字符串比较
        //-------------
        ...
        //false表示不包含边界
        //NumberTools.stringToLong("000000000000rs");
        queryAndPrintResult(query);
    ...
    public void testPhraseQuery() {
        ...
        // phraseQuery.add(new Term("content", "饭店"), 4);//这些位置是相对的，任意定义

        phraseQuery.add(new Term("content", "绅士"));
        phraseQuery.add(new Term("content", "饭店"));
        phraseQuery.setSlop(2);//最多中间不超过两个，若term有位置，还是以这个为准
